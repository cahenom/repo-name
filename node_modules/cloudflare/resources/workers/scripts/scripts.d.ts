...
import { Content, ContentGetParams, ContentUpdateParams } from "./content.js";
import * as DeploymentsAPI from "./deployments.js";
import { Deployment, DeploymentCreateParams, DeploymentCreateResponse, DeploymentGetParams, DeploymentGetResponse, Deployments } from "./deployments.js";
import * as SchedulesAPI from "./schedules.js";
import { Schedule, ScheduleGetParams, ScheduleGetResponse, ScheduleUpdateParams, ScheduleUpdateResponse, Schedules } from "./schedules.js";
import * as SettingsAPI from "./settings.js";
import { SettingEditParams, SettingGetParams, Settings } from "./settings.js";
import * as SubdomainAPI from "./subdomain.js";
import { Subdomain, SubdomainCreateParams, SubdomainCreateResponse, SubdomainGetParams, SubdomainGetResponse } from "./subdomain.js";
import * as TailAPI from "./tail.js";
import { ConsumerScript, Tail, TailCreateParams, TailCreateResponse, TailDeleteParams, TailDeleteResponse, TailGetParams, TailGetResponse } from "./tail.js";
import * as VersionsAPI from "./versions.js";
import { VersionCreateParams, VersionCreateResponse, VersionGetParams, VersionGetResponse, VersionListParams, VersionListResponse, VersionListResponsesV4PagePagination, Versions } from "./versions.js";
import * as AssetsAPI from "./assets/assets.js";
import { Assets as AssetsAPIAssets } from "./assets/assets.js";
import { SinglePage } from "../../../pagination.js";
export declare class Scripts extends APIResource {
    assets: AssetsAPI.Assets;
    subdomain: SubdomainAPI.Subdomain;
...
export declare namespace ScriptSetting {
    /**
     * Observability settings for the Worker.
     */
...
export declare namespace ScriptUpdateResponse {
    /**
     * Configuration for
     * [Smart Placement](https://developers.cloudflare.com/workers/configuration/smart-placement).
     */
...
export declare namespace Scripts {
    export { type Script as Script, type ScriptSetting as ScriptSetting, type ScriptUpdateResponse as ScriptUpdateResponse, type ScriptGetResponse as ScriptGetResponse, ScriptsSinglePage as ScriptsSinglePage, type ScriptUpdateParams as ScriptUpdateParams, type ScriptListParams as ScriptListParams, type ScriptDeleteParams as ScriptDeleteParams, type ScriptGetParams as ScriptGetParams, };
    export { AssetsAPIAssets as Assets };
    export { Subdomain as Subdomain, type SubdomainCreateResponse as SubdomainCreateResponse, type SubdomainGetResponse as SubdomainGetResponse, type SubdomainCreateParams as SubdomainCreateParams, type SubdomainGetParams as SubdomainGetParams, };
    export { Schedules as Schedules, type Schedule as Schedule, type ScheduleUpdateResponse as ScheduleUpdateResponse, type ScheduleGetResponse as ScheduleGetResponse, type ScheduleUpdateParams as ScheduleUpdateParams, type ScheduleGetParams as ScheduleGetParams, };
    export { Tail as Tail, type ConsumerScript as ConsumerScript, type TailCreateResponse as TailCreateResponse, type TailDeleteResponse as TailDeleteResponse, type TailGetResponse as TailGetResponse, type TailCreateParams as TailCreateParams, type TailDeleteParams as TailDeleteParams, type TailGetParams as TailGetParams, };
    export { Content as Content, type ContentUpdateParams as ContentUpdateParams, type ContentGetParams as ContentGetParams, };
    export { Settings as Settings, type SettingEditParams as SettingEditParams, type SettingGetParams as SettingGetParams, };
    export { Deployments as Deployments, type Deployment as Deployment, type DeploymentCreateResponse as DeploymentCreateResponse, type DeploymentGetResponse as DeploymentGetResponse, type DeploymentCreateParams as DeploymentCreateParams, type DeploymentGetParams as DeploymentGetParams, };
    export { Versions as Versions, type VersionCreateResponse as VersionCreateResponse, type VersionListResponse as VersionListResponse, type VersionGetResponse as VersionGetResponse, VersionListResponsesV4PagePagination as VersionListResponsesV4PagePagination, type VersionCreateParams as VersionCreateParams, type VersionListParams as VersionListParams, type VersionGetParams as VersionGetParams, };
}

...
import * as AudioTracksAPI from "./audio-tracks.js";
import { Audio, AudioTrackCopyParams, AudioTrackDeleteParams, AudioTrackDeleteResponse, AudioTrackEditParams, AudioTrackGetParams, AudioTrackGetResponse, AudioTracks } from "./audio-tracks.js";
import * as ClipAPI from "./clip.js";
import { Clip, ClipCreateParams, ClipResource } from "./clip.js";
import * as CopyAPI from "./copy.js";
import { Copy, CopyCreateParams } from "./copy.js";
import * as DirectUploadAPI from "./direct-upload.js";
import { DirectUpload, DirectUploadCreateParams, DirectUploadCreateResponse } from "./direct-upload.js";
import * as DownloadsAPI from "./downloads.js";
import { DownloadCreateParams, DownloadCreateResponse, DownloadDeleteParams, DownloadDeleteResponse, DownloadGetParams, DownloadGetResponse, Downloads } from "./downloads.js";
import * as EmbedAPI from "./embed.js";
import { Embed, EmbedGetParams, EmbedGetResponse } from "./embed.js";
import * as KeysAPI from "./keys.js";
import { KeyCreateParams, KeyDeleteParams, KeyDeleteResponse, KeyGetParams, KeyGetResponse, Keys } from "./keys.js";
import * as TokenAPI from "./token.js";
import { Token, TokenCreateParams, TokenCreateResponse } from "./token.js";
import * as VideosAPI from "./videos.js";
import { VideoStorageUsageParams, VideoStorageUsageResponse, Videos } from "./videos.js";
import * as WatermarksAPI from "./watermarks.js";
import { Watermark, WatermarkCreateParams, WatermarkDeleteParams, WatermarkDeleteResponse, WatermarkGetParams, WatermarkListParams, Watermarks, WatermarksSinglePage } from "./watermarks.js";
import * as WebhooksAPI from "./webhooks.js";
import { WebhookDeleteParams, WebhookDeleteResponse, WebhookGetParams, WebhookGetResponse, WebhookUpdateParams, WebhookUpdateResponse, Webhooks } from "./webhooks.js";
import * as CaptionsAPI from "./captions/captions.js";
import { Caption, CaptionGetParams, CaptionGetResponse, Captions } from "./captions/captions.js";
import * as LiveInputsAPI from "./live-inputs/live-inputs.js";
import { LiveInput, LiveInputCreateParams, LiveInputDeleteParams, LiveInputGetParams, LiveInputListParams, LiveInputListResponse, LiveInputUpdateParams, LiveInputs } from "./live-inputs/live-inputs.js";
...
export declare namespace Stream {
    export { AudioTracks as AudioTracks, type Audio as Audio, type AudioTrackDeleteResponse as AudioTrackDeleteResponse, type AudioTrackGetResponse as AudioTrackGetResponse, type AudioTrackDeleteParams as AudioTrackDeleteParams, type AudioTrackCopyParams as AudioTrackCopyParams, type AudioTrackEditParams as AudioTrackEditParams, type AudioTrackGetParams as AudioTrackGetParams, };
    export { Videos as Videos, type VideoStorageUsageResponse as VideoStorageUsageResponse, type VideoStorageUsageParams as VideoStorageUsageParams, };
    ...
    export { DirectUpload as DirectUpload, type DirectUploadCreateResponse as DirectUploadCreateResponse, type DirectUploadCreateParams as DirectUploadCreateParams, };
    export { type Keys as Keys, type KeyDeleteResponse as KeyDeleteResponse, type KeyGetResponse as KeyGetResponse, type KeyCreateParams as KeyCreateParams, type KeyDeleteParams as KeyDeleteParams, type KeyGetParams as KeyGetParams, };
    export { LiveInputs as LiveInputs, type LiveInput as LiveInput, type LiveInputListResponse as LiveInputListResponse, type LiveInputCreateParams as LiveInputCreateParams, type LiveInputUpdateParams as LiveInputUpdateParams, type LiveInputListParams as LiveInputListParams, type LiveInputDeleteParams as LiveInputDeleteParams, type LiveInputGetParams as LiveInputGetParams, };
    export { Watermarks as Watermarks, type Watermark as Watermark, type WatermarkDeleteResponse as WatermarkDeleteResponse, WatermarksSinglePage as WatermarksSinglePage, type WatermarkCreateParams as WatermarkCreateParams, type WatermarkListParams as WatermarkListParams, type WatermarkDeleteParams as WatermarkDeleteParams, type WatermarkGetParams as WatermarkGetParams, };
    export { Webhooks as Webhooks, type WebhookUpdateResponse as WebhookUpdateResponse, type WebhookDeleteResponse as WebhookDeleteResponse, type WebhookGetResponse as WebhookGetResponse, type WebhookUpdateParams as WebhookUpdateParams, type WebhookDeleteParams as WebhookDeleteParams, type WebhookGetParams as WebhookGetParams, };
    export { Captions as Captions, type Caption as Caption, type CaptionGetResponse as CaptionGetResponse, type CaptionGetParams as CaptionGetParams, };
    export { Downloads as Downloads, type DownloadCreateResponse as DownloadCreateResponse, type DownloadDeleteResponse as DownloadDeleteResponse, type DownloadGetResponse as DownloadGetResponse, type DownloadCreateParams as DownloadCreateParams, type DownloadDeleteParams as DownloadDeleteParams, type DownloadGetParams as DownloadGetParams, };
    export { Embed as Embed, type EmbedGetResponse as EmbedGetResponse, type EmbedGetParams as EmbedGetParams };
    export { Token as Token, type TokenCreateResponse as TokenCreateResponse, type TokenCreateParams as TokenCreateParams, };
}

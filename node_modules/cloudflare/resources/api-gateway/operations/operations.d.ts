...
export declare class Operations extends APIResource {
     ...
     */
    bulkCreate(params: OperationBulkCreateParams, options?: Core.RequestOptions): Core.APIPromise<OperationBulkCreateResponse>;
    /**
...
export declare namespace OperationBulkCreateResponse {
    interface OperationBulkCreateResponseItem {
        /**
         * The endpoint which can contain path parameter templates in curly braces, each
         * will be replaced from left to right with {varN}, starting with {var1}, during
         * insertion. This will further be Cloudflare-normalized upon insertion. See:
         ...
         */
        operation_id: string;
        features?: OperationBulkCreateResponseItem.APIShieldOperationFeatureThresholds | OperationBulkCreateResponseItem.APIShieldOperationFeatureParameterSchemas | OperationBulkCreateResponseItem.APIShieldOperationFeatureAPIRouting | OperationBulkCreateResponseItem.APIShieldOperationFeatureConfidenceIntervals | OperationBulkCreateResponseItem.APIShieldOperationFeatureSchemaInfo;
    }
    namespace OperationBulkCreateResponseItem {
        interface APIShieldOperationFeatureThresholds {
            thresholds?: APIShieldOperationFeatureThresholds.Thresholds;
        }
        namespace APIShieldOperationFeatureThresholds {

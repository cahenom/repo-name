...
import { PreviewGetParams, PreviewGetResponse, Previews } from "./previews.js";
import * as RegionsAPI from "./regions.js";
import { RegionGetParams, RegionGetResponse, RegionListParams, RegionListResponse, Regions } from "./regions.js";
import * as SearchesAPI from "./searches.js";
import { SearchGetParams, SearchGetResponse, Searches } from "./searches.js";
import * as MonitorsAPI from "./monitors/monitors.js";
import { Monitor, MonitorCreateParams, MonitorDeleteParams, MonitorDeleteResponse, MonitorEditParams, MonitorGetParams, MonitorListParams, MonitorUpdateParams, Monitors, MonitorsSinglePage } from "./monitors/monitors.js";
import * as PoolsAPI from "./pools/pools.js";
import { Pool, PoolBulkEditParams, PoolBulkEditResponse, PoolCreateParams, PoolDeleteParams, PoolDeleteResponse, PoolEditParams, PoolGetParams, PoolListParams, PoolUpdateParams, Pools, PoolsSinglePage } from "./pools/pools.js";
import { SinglePage } from "../../pagination.js";
export declare class LoadBalancers extends APIResource {
    monitors: MonitorsAPI.Monitors;
    pools: PoolsAPI.Pools;
    previews: PreviewsAPI.Previews;
    regions: RegionsAPI.Regions;
    searches: SearchesAPI.Searches;
    /**
...
export declare class LoadBalancersSinglePage extends SinglePage<LoadBalancer> {
}
/**
...
export declare namespace RulesParam {
    /**
     * A collection of fields used to directly respond to the eyeball instead of
     * routing to a pool. If a fixed_response is supplied the rule will be marked as
     * terminates.

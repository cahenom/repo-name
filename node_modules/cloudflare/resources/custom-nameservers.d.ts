...
export declare class CustomNameservers extends APIResource {
     ...
     */
    delete(customNSId: string, params: CustomNameserverDeleteParams, options?: Core.RequestOptions): Core.APIPromise<CustomNameserverDeleteResponse>;
    /**
     * Get Eligible Zones for Account Custom Nameservers
     */
    availabilty(params: CustomNameserverAvailabiltyParams, options?: Core.RequestOptions): Core.APIPromise<CustomNameserverAvailabiltyResponse>;
    /**

...
import { SinglePage, V4PagePaginationArray } from "../pagination.js";
...
export declare namespace CloudflareTunnel {
...
export declare namespace Result {
    ...
    interface AaaAPIResponseCommon {
        errors: Array<Shared.ResponseInfo>;
        messages: Array<Shared.ResponseInfo>;
        /**
...
export declare namespace TokenPolicy {
    /**
     * A named group of permissions that map to a group of operations against
     * resources.
     */
...
export declare namespace TokenPolicyParam {
    /**
     * A named group of permissions that map to a group of operations against
     * resources.
     */
...
export declare class MembersV4PagePaginationArray extends V4PagePaginationArray<Member> {
}
export declare class RolesSinglePage extends SinglePage<Role> {
}
export declare class TokensV4PagePaginationArray extends V4PagePaginationArray<Token> {
}
export declare class AuditLogsV4PagePaginationArray extends V4PagePaginationArray<AuditLog> {
}

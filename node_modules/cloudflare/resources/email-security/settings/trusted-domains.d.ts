...
export declare class TrustedDomains extends APIResource {
    /**
     ...
     */
    delete(trustedDomainId: number, params: TrustedDomainDeleteParams, options?: Core.RequestOptions): Core.APIPromise<TrustedDomainDeleteResponse>;
    /**
     * Update a trusted email domain
     */
    edit(trustedDomainId: number, params: TrustedDomainEditParams, options?: Core.RequestOptions): Core.APIPromise<TrustedDomainEditResponse>;
    /**
     * Get a trusted email domain
     */
    get(trustedDomainId: number, params: TrustedDomainGetParams, options?: Core.RequestOptions): Core.APIPromise<TrustedDomainGetResponse>;
}
export declare class TrustedDomainListResponsesV4PagePaginationArray extends V4PagePaginationArray<TrustedDomainListResponse> {
}
...
export declare namespace TrustedDomainCreateResponse {
    interface EmailSecurityTrustedDomain {
        /**
...
export declare namespace TrustedDomainCreateParams {
    interface EmailSecurityCreateTrustedDomain {
        /**

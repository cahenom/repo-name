...
import * as AllowPoliciesAPI from "./allow-policies.js";
import { AllowPolicies, AllowPolicyCreateParams, AllowPolicyCreateResponse, AllowPolicyDeleteParams, AllowPolicyDeleteResponse, AllowPolicyEditParams, AllowPolicyEditResponse, AllowPolicyGetParams, AllowPolicyGetResponse, AllowPolicyListParams, AllowPolicyListResponse, AllowPolicyListResponsesV4PagePaginationArray } from "./allow-policies.js";
import * as BlockSendersAPI from "./block-senders.js";
import { BlockSenderCreateParams, BlockSenderCreateResponse, BlockSenderDeleteParams, BlockSenderDeleteResponse, BlockSenderEditParams, BlockSenderEditResponse, BlockSenderGetParams, BlockSenderGetResponse, BlockSenderListParams, BlockSenderListResponse, BlockSenderListResponsesV4PagePaginationArray, BlockSenders } from "./block-senders.js";
import * as DomainsAPI from "./domains.js";
import { DomainBulkDeleteParams, DomainBulkDeleteResponse, DomainDeleteParams, DomainDeleteResponse, DomainEditParams, DomainEditResponse, DomainGetParams, DomainGetResponse, DomainListParams, DomainListResponse, DomainListResponsesV4PagePaginationArray, Domains } from "./domains.js";
import * as ImpersonationRegistryAPI from "./impersonation-registry.js";
import { ImpersonationRegistry, ImpersonationRegistryCreateParams, ImpersonationRegistryCreateResponse, ImpersonationRegistryDeleteParams, ImpersonationRegistryDeleteResponse, ImpersonationRegistryEditParams, ImpersonationRegistryEditResponse, ImpersonationRegistryGetParams, ImpersonationRegistryGetResponse, ImpersonationRegistryListParams, ImpersonationRegistryListResponse, ImpersonationRegistryListResponsesV4PagePaginationArray } from "./impersonation-registry.js";
import * as TrustedDomainsAPI from "./trusted-domains.js";
import { TrustedDomainCreateParams, TrustedDomainCreateResponse, TrustedDomainDeleteParams, TrustedDomainDeleteResponse, TrustedDomainEditParams, TrustedDomainEditResponse, TrustedDomainGetParams, TrustedDomainGetResponse, TrustedDomainListParams, TrustedDomainListResponse, TrustedDomainListResponsesV4PagePaginationArray, TrustedDomains } from "./trusted-domains.js";
export declare class Settings extends APIResource {
    allowPolicies: AllowPoliciesAPI.AllowPolicies;
    blockSenders: BlockSendersAPI.BlockSenders;
    domains: DomainsAPI.Domains;
    impersonationRegistry: ImpersonationRegistryAPI.ImpersonationRegistry;
    trustedDomains: TrustedDomainsAPI.TrustedDomains;
}
export declare namespace Settings {
    export { AllowPolicies as AllowPolicies, type AllowPolicyCreateResponse as AllowPolicyCreateResponse, type AllowPolicyListResponse as AllowPolicyListResponse, type AllowPolicyDeleteResponse as AllowPolicyDeleteResponse, type AllowPolicyEditResponse as AllowPolicyEditResponse, type AllowPolicyGetResponse as AllowPolicyGetResponse, AllowPolicyListResponsesV4PagePaginationArray as AllowPolicyListResponsesV4PagePaginationArray, type AllowPolicyCreateParams as AllowPolicyCreateParams, type AllowPolicyListParams as AllowPolicyListParams, type AllowPolicyDeleteParams as AllowPolicyDeleteParams, type AllowPolicyEditParams as AllowPolicyEditParams, type AllowPolicyGetParams as AllowPolicyGetParams, };

...
export declare namespace Aegis {
    /**
     * Value of the zone setting.
     */
    interface Value {
...
export declare namespace NELParam {
    /**
     * Current value of the zone setting.
     */
    interface Value {
...
export declare namespace SecurityHeadersParam {
    /**
     * Current value of the zone setting.
     */
    interface Value {
 ...
 * 0-RTT session resumption enabled for this zone.
 */
export type SettingGetResponse = ZeroRTT | AdvancedDDoS | AlwaysOnline | SettingGetResponse.ZonesSchemasAlwaysUseHTTPS | SettingGetResponse.ZonesSchemasAutomaticHTTPSRewrites | Brotli | SettingGetResponse.ZonesSchemasBrowserCacheTTL | SettingGetResponse.ZonesSchemasBrowserCheck | SettingGetResponse.ZonesSchemasCacheLevel | ChallengeTTL | Ciphers | SettingGetResponse.ZonesCNAMEFlattening | DevelopmentMode | EarlyHints | SettingGetResponse.ZonesSchemasEdgeCacheTTL | SettingGetResponse.ZonesSchemasEmailObfuscation | H2Prioritization | HotlinkProtection | HTTP2 | HTTP3 | ImageResizing | SettingGetResponse.ZonesSchemasIPGeolocation | IPV6 | SettingGetResponse.ZonesMaxUpload | MinTLSVersion | SettingGetResponse.ZonesSchemasMirage | NEL | SettingGetResponse.ZonesSchemasOpportunisticEncryption | OpportunisticOnion | OrangeToOrange | SettingGetResponse.ZonesSchemasOriginErrorPagePassThru | SettingGetResponse.ZonesSchemasPolish | PrefetchPreload | ProxyReadTimeout | PseudoIPV4 | SettingGetResponse.ZonesReplaceInsecureJS | SettingGetResponse.ZonesSchemasResponseBuffering | SettingGetResponse.ZonesSchemasRocketLoader | SettingGetResponse.ZonesSchemasAutomaticPlatformOptimization | SecurityHeaders | SettingGetResponse.ZonesSchemasSecurityLevel | ServerSideExcludes | SettingGetResponse.ZonesSha1Support | SettingGetResponse.ZonesSchemasSortQueryStringForCache | SettingGetResponse.ZonesSchemasSSL | SSLRecommender | SettingGetResponse.ZonesTLS1_2Only | TLS1_3 | TLSClientAuth | SettingGetResponse.ZonesSchemasTrueClientIPHeader | SettingGetResponse.ZonesSchemasWAF | WebP | Websocket;
...
export type SettingEditParams = SettingEditParams.ZeroRTT | SettingEditParams.AdvancedDDoS | SettingEditParams.AlwaysOnline | SettingEditParams.ZonesSchemasAlwaysUseHTTPS | SettingEditParams.ZonesSchemasAutomaticHTTPSRewrites | SettingEditParams.Brotli | SettingEditParams.ZonesSchemasBrowserCacheTTL | SettingEditParams.ZonesSchemasBrowserCheck | SettingEditParams.ZonesSchemasCacheLevel | SettingEditParams.ChallengeTTL | SettingEditParams.Ciphers | SettingEditParams.ZonesCNAMEFlattening | SettingEditParams.DevelopmentMode | SettingEditParams.EarlyHints | SettingEditParams.ZonesSchemasEdgeCacheTTL | SettingEditParams.ZonesSchemasEmailObfuscation | SettingEditParams.H2Prioritization | SettingEditParams.HotlinkProtection | SettingEditParams.HTTP2 | SettingEditParams.HTTP3 | SettingEditParams.ImageResizing | SettingEditParams.ZonesSchemasIPGeolocation | SettingEditParams.IPV6 | SettingEditParams.ZonesMaxUpload | SettingEditParams.MinTLSVersion | SettingEditParams.ZonesSchemasMirage | SettingEditParams.NEL | SettingEditParams.ZonesSchemasOpportunisticEncryption | SettingEditParams.OpportunisticOnion | SettingEditParams.OrangeToOrange | SettingEditParams.ZonesSchemasOriginErrorPagePassThru | SettingEditParams.ZonesSchemasPolish | SettingEditParams.PrefetchPreload | SettingEditParams.ProxyReadTimeout | SettingEditParams.PseudoIPV4 | SettingEditParams.ZonesReplaceInsecureJS | SettingEditParams.ZonesSchemasResponseBuffering | SettingEditParams.ZonesSchemasRocketLoader | SettingEditParams.ZonesSchemasAutomaticPlatformOptimization | SettingEditParams.SecurityHeaders | SettingEditParams.ZonesSchemasSecurityLevel | SettingEditParams.ServerSideExcludes | SettingEditParams.ZonesSha1Support | SettingEditParams.ZonesSchemasSortQueryStringForCache | SettingEditParams.ZonesSchemasSSL | SettingEditParams.SSLRecommender | SettingEditParams.ZonesTLS1_2Only | SettingEditParams.TLS1_3 | SettingEditParams.TLSClientAuth | SettingEditParams.ZonesSchemasTrueClientIPHeader | SettingEditParams.ZonesSchemasWAF | SettingEditParams.WebP | SettingEditParams.Websocket;
...
export declare namespace Settings {
    export { type AdvancedDDoS as AdvancedDDoS, type Aegis as Aegis, type AlwaysOnline as AlwaysOnline, type AlwaysUseHTTPS as AlwaysUseHTTPS, type AutomaticHTTPSRewrites as AutomaticHTTPSRewrites, type AutomaticPlatformOptimization as AutomaticPlatformOptimization, type Brotli as Brotli, type BrowserCacheTTL as BrowserCacheTTL, type BrowserCheck as BrowserCheck, type CacheLevel as CacheLevel, type ChallengeTTL as ChallengeTTL, type Ciphers as Ciphers, type DevelopmentMode as DevelopmentMode, type EarlyHints as EarlyHints, type EmailObfuscation as EmailObfuscation, type FontSettings as FontSettings, type H2Prioritization as H2Prioritization, type HotlinkProtection as HotlinkProtection, type HTTP2 as HTTP2, type HTTP3 as HTTP3, type ImageResizing as ImageResizing, type IPGeolocation as IPGeolocation, type IPV6 as IPV6, type MinTLSVersion as MinTLSVersion, type Mirage as Mirage, type NEL as NEL, type OpportunisticEncryption as OpportunisticEncryption, type OpportunisticOnion as OpportunisticOnion, type OrangeToOrange as OrangeToOrange, type OriginErrorPagePassThru as OriginErrorPagePassThru, type OriginMaxHTTPVersion as OriginMaxHTTPVersion, type Polish as Polish, type PrefetchPreload as PrefetchPreload, type ProxyReadTimeout as ProxyReadTimeout, type PseudoIPV4 as PseudoIPV4, type ResponseBuffering as ResponseBuffering, type RocketLoader as RocketLoader, type SecurityHeaders as SecurityHeaders, type SecurityLevel as SecurityLevel, type ServerSideExcludes as ServerSideExcludes, type SortQueryStringForCache as SortQueryStringForCache, type SSL as SSL, type SSLRecommender as SSLRecommender, type TLS1_3 as TLS1_3, type TLSClientAuth as TLSClientAuth, type TrueClientIPHeader as TrueClientIPHeader, type WAF as WAF, type WebP as WebP, type Websocket as Websocket, type ZeroRTT as ZeroRTT, type SettingEditResponse as SettingEditResponse, type SettingGetResponse as SettingGetResponse, type SettingEditParams as SettingEditParams, type SettingGetParams as SettingGetParams, };
}

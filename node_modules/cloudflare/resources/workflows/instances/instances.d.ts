...
export interface InstanceCreateResponse {
    id: string;
    status: 'queued' | 'running' | 'paused' | 'errored' | 'terminated' | 'complete' | 'waitingForPause' | 'waiting' | 'unknown';
    version_id: string;
    workflow_id: string;
}
...
export interface InstanceGetResponse {
    ...
    start: string | null;
    status: 'queued' | 'running' | 'paused' | 'errored' | 'terminated' | 'complete' | 'waitingForPause' | 'waiting' | 'unknown';
    steps: Array<InstanceGetResponse.UnionMember0 | InstanceGetResponse.UnionMember1 | InstanceGetResponse.UnionMember2>;

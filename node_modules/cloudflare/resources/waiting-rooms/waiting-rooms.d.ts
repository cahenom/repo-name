...
import { Page, PagePreviewParams, PagePreviewResponse } from "./page.js";
import * as RulesAPI from "./rules.js";
import { RuleCreateParams, RuleCreateResponse, RuleDeleteParams, RuleDeleteResponse, RuleEditParams, RuleEditResponse, RuleGetParams, RuleGetResponse, RuleUpdateParams, RuleUpdateResponse, Rules, WaitingRoomRule } from "./rules.js";
import * as SettingsAPI from "./settings.js";
import { Setting, SettingEditParams, SettingEditResponse, SettingGetParams, SettingGetResponse, SettingUpdateParams, SettingUpdateResponse, Settings } from "./settings.js";
import * as StatusesAPI from "./statuses.js";
import { StatusGetParams, StatusGetResponse, Statuses } from "./statuses.js";
import * as EventsAPI from "./events/events.js";
import { Event, EventCreateParams, EventDeleteParams, EventDeleteResponse, EventEditParams, EventGetParams, EventListParams, EventUpdateParams, Events, EventsV4PagePaginationArray } from "./events/events.js";
import { V4PagePaginationArray, type V4PagePaginationArrayParams } from "../../pagination.js";
export declare class WaitingRooms extends APIResource {
    page: PageAPI.Page;
...
export declare class WaitingRoomsV4PagePaginationArray extends V4PagePaginationArray<WaitingRoom> {
}
...
export interface Query {
     ...
     */
    default_template_language?: 'en-US' | 'es-ES' | 'de-DE' | 'fr-FR' | 'it-IT' | 'ja-JP' | 'ko-KR' | 'pt-BR' | 'zh-CN' | 'zh-TW' | 'nl-NL' | 'pl-PL' | 'id-ID' | 'tr-TR' | 'ar-EG' | 'ru-RU' | 'fa-IR' | 'bg-BG' | 'hr-HR' | 'cs-CZ' | 'da-DK' | 'fi-FI' | 'lt-LT' | 'ms-MY' | 'nb-NO' | 'ro-RO' | 'el-GR' | 'he-IL' | 'hi-IN' | 'hu-HU' | 'sr-BA' | 'sk-SK' | 'sl-SI' | 'sv-SE' | 'tl-PH' | 'th-TH' | 'uk-UA' | 'vi-VN';
    /**
...
export declare namespace WaitingRooms {
    export { Page as Page, type PagePreviewResponse as PagePreviewResponse, type PagePreviewParams as PagePreviewParams, };
    export { Events as Events, type Event as Event, type EventDeleteResponse as EventDeleteResponse, EventsV4PagePaginationArray as EventsV4PagePaginationArray, type EventCreateParams as EventCreateParams, type EventUpdateParams as EventUpdateParams, type EventListParams as EventListParams, type EventDeleteParams as EventDeleteParams, type EventEditParams as EventEditParams, type EventGetParams as EventGetParams, };
    export { Rules as Rules, type WaitingRoomRule as WaitingRoomRule, type RuleCreateResponse as RuleCreateResponse, type RuleUpdateResponse as RuleUpdateResponse, type RuleDeleteResponse as RuleDeleteResponse, type RuleEditResponse as RuleEditResponse, type RuleGetResponse as RuleGetResponse, type RuleCreateParams as RuleCreateParams, type RuleUpdateParams as RuleUpdateParams, type RuleDeleteParams as RuleDeleteParams, type RuleEditParams as RuleEditParams, type RuleGetParams as RuleGetParams, };
    export { Statuses as Statuses, type StatusGetResponse as StatusGetResponse, type StatusGetParams as StatusGetParams, };
    export { Settings as Settings, type Setting as Setting, type SettingUpdateResponse as SettingUpdateResponse, type SettingEditResponse as SettingEditResponse, type SettingGetResponse as SettingGetResponse, type SettingUpdateParams as SettingUpdateParams, type SettingEditParams as SettingEditParams, type SettingGetParams as SettingGetParams, };
}

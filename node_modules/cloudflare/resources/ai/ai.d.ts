...
import * as AuthorsAPI from "./authors.js";
import { AuthorListParams, AuthorListResponse, AuthorListResponsesSinglePage, Authors } from "./authors.js";
import * as TasksAPI from "./tasks.js";
import { TaskListParams, TaskListResponse, TaskListResponsesSinglePage, Tasks } from "./tasks.js";
import * as FinetunesAPI from "./finetunes/finetunes.js";
import { FinetuneCreateParams, FinetuneCreateResponse, FinetuneListParams, FinetuneListResponse, Finetunes } from "./finetunes/finetunes.js";
import * as ModelsAPI from "./models/models.js";
import { ModelListParams, ModelListResponse, ModelListResponsesV4PagePaginationArray, Models } from "./models/models.js";
export declare class AI extends APIResource {
    finetunes: FinetunesAPI.Finetunes;
    authors: AuthorsAPI.Authors;
 ...
 */
export type AIRunResponse = Array<AIRunResponse.TextClassification> | Core.Uploadable | AIRunResponse.Audio | AIRunResponse.TextEmbeddings | AIRunResponse.AutomaticSpeechRecognition | Array<AIRunResponse.ImageClassification> | Array<AIRunResponse.ObjectDetection> | AIRunResponse.UnionMember7 | AIRunResponse.Translation | AIRunResponse.Summarization | AIRunResponse.ImageToText;
...
export type AIRunParams = AIRunParams.TextClassification | AIRunParams.TextToImage | AIRunParams.TextToSpeech | AIRunParams.TextEmbeddings | AIRunParams.AutomaticSpeechRecognition | AIRunParams.ImageClassification | AIRunParams.ObjectDetection | AIRunParams.Prompt | AIRunParams.Messages | AIRunParams.Translation | AIRunParams.Summarization | AIRunParams.ImageToText;
...
export declare namespace AI {
    export { Finetunes as Finetunes, type FinetuneCreateResponse as FinetuneCreateResponse, type FinetuneListResponse as FinetuneListResponse, type FinetuneCreateParams as FinetuneCreateParams, type FinetuneListParams as FinetuneListParams, };
    export { Authors as Authors, type AuthorListResponse as AuthorListResponse, AuthorListResponsesSinglePage as AuthorListResponsesSinglePage, type AuthorListParams as AuthorListParams, };
    export { Tasks as Tasks, type TaskListResponse as TaskListResponse, TaskListResponsesSinglePage as TaskListResponsesSinglePage, type TaskListParams as TaskListParams, };
    export { Models as Models, type ModelListResponse as ModelListResponse, ModelListResponsesV4PagePaginationArray as ModelListResponsesV4PagePaginationArray, type ModelListParams as ModelListParams, };
}

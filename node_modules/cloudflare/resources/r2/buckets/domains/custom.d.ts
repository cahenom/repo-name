...
export declare class Custom extends APIResource {
     ...
     */
    create(bucketName: string, params: CustomCreateParams, options?: Core.RequestOptions): Core.APIPromise<CustomCreateResponse>;
    /**
     * Edit the configuration for a custom domain on an existing R2 bucket.
     */
    update(bucketName: string, domainName: string, params: CustomUpdateParams, options?: Core.RequestOptions): Core.APIPromise<CustomUpdateResponse>;
    /**
     * Gets a list of all custom domains registered with an existing R2 bucket.
     */
    list(bucketName: string, params: CustomListParams, options?: Core.RequestOptions): Core.APIPromise<CustomListResponse>;
    /**
     * Remove custom domain registration from an existing R2 bucket
     */
    delete(bucketName: string, domainName: string, params: CustomDeleteParams, options?: Core.RequestOptions): Core.APIPromise<CustomDeleteResponse>;
    /**
     * Get the configuration for a custom domain on an existing R2 bucket.
     */
    get(bucketName: string, domainName: string, params: CustomGetParams, options?: Core.RequestOptions): Core.APIPromise<CustomGetResponse>;
}
...
export declare namespace CustomGetResponse {
    interface Status {
        /**
         * Ownership status of the domain
         */

...
import { DHCPRelay, DHCPServer, LAN, LANCreateParams, LANCreateResponse, LANDeleteParams, LANEditParams, LANGetParams, LANListParams, LANStaticAddressing, LANUpdateParams, LANs, LANsSinglePage, Nat, RoutedSubnet } from "./lans.js";
import * as WANsAPI from "./wans.js";
import { WAN, WANCreateParams, WANCreateResponse, WANDeleteParams, WANEditParams, WANGetParams, WANListParams, WANStaticAddressing, WANUpdateParams, WANs, WANsSinglePage } from "./wans.js";
...
export declare namespace Sites {
    ...
    export { LANs as LANs, type DHCPRelay as DHCPRelay, type DHCPServer as DHCPServer, type LAN as LAN, type LANStaticAddressing as LANStaticAddressing, type Nat as Nat, type RoutedSubnet as RoutedSubnet, type LANCreateResponse as LANCreateResponse, LANsSinglePage as LANsSinglePage, type LANCreateParams as LANCreateParams, type LANUpdateParams as LANUpdateParams, type LANListParams as LANListParams, type LANDeleteParams as LANDeleteParams, type LANEditParams as LANEditParams, type LANGetParams as LANGetParams, };
    export { WANs as WANs, type WAN as WAN, type WANStaticAddressing as WANStaticAddressing, type WANCreateResponse as WANCreateResponse, WANsSinglePage as WANsSinglePage, type WANCreateParams as WANCreateParams, type WANUpdateParams as WANUpdateParams, type WANListParams as WANListParams, type WANDeleteParams as WANDeleteParams, type WANEditParams as WANEditParams, type WANGetParams as WANGetParams, };
}

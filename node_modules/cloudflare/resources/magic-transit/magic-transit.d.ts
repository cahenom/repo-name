...
import { AppCreateParams, AppCreateResponse, AppDeleteParams, AppDeleteResponse, AppListParams, AppListResponse, AppListResponsesSinglePage, AppUpdateParams, AppUpdateResponse, Apps } from "./apps.js";
import * as CfInterconnectsAPI from "./cf-interconnects.js";
import { CfInterconnectBulkUpdateParams, CfInterconnectBulkUpdateResponse, CfInterconnectGetParams, CfInterconnectGetResponse, CfInterconnectListParams, CfInterconnectListResponse, CfInterconnectUpdateParams, CfInterconnectUpdateResponse, CfInterconnects } from "./cf-interconnects.js";
import * as ConnectorsAPI from "./connectors.js";
import { ConnectorEditParams, ConnectorEditResponse, ConnectorGetParams, ConnectorGetResponse, ConnectorListParams, ConnectorListResponse, ConnectorListResponsesSinglePage, ConnectorUpdateParams, ConnectorUpdateResponse, Connectors } from "./connectors.js";
import * as GRETunnelsAPI from "./gre-tunnels.js";
import { GRETunnelBulkUpdateParams, GRETunnelBulkUpdateResponse, GRETunnelCreateParams, GRETunnelCreateResponse, GRETunnelDeleteParams, GRETunnelDeleteResponse, GRETunnelGetParams, GRETunnelGetResponse, GRETunnelListParams, GRETunnelListResponse, GRETunnelUpdateParams, GRETunnelUpdateResponse, GRETunnels } from "./gre-tunnels.js";
import * as IPSECTunnelsAPI from "./ipsec-tunnels.js";
import { IPSECTunnelBulkUpdateParams, IPSECTunnelBulkUpdateResponse, IPSECTunnelCreateParams, IPSECTunnelCreateResponse, IPSECTunnelDeleteParams, IPSECTunnelDeleteResponse, IPSECTunnelGetParams, IPSECTunnelGetResponse, IPSECTunnelListParams, IPSECTunnelListResponse, IPSECTunnelPSKGenerateParams, IPSECTunnelPSKGenerateResponse, IPSECTunnelUpdateParams, IPSECTunnelUpdateResponse, IPSECTunnels, PSKMetadata } from "./ipsec-tunnels.js";
import * as RoutesAPI from "./routes.js";
import { RouteBulkUpdateParams, RouteBulkUpdateResponse, RouteCreateParams, RouteCreateResponse, RouteDeleteParams, RouteDeleteResponse, RouteEmptyParams, RouteEmptyResponse, RouteGetParams, RouteGetResponse, RouteListParams, RouteListResponse, RouteUpdateParams, RouteUpdateResponse, Routes, Scope } from "./routes.js";
import * as PCAPsAPI from "./pcaps/pcaps.js";
import { PCAP, PCAPCreateParams, PCAPCreateResponse, PCAPFilter, PCAPGetParams, PCAPGetResponse, PCAPListParams, PCAPListResponse, PCAPListResponsesSinglePage, PCAPs } from "./pcaps/pcaps.js";
import * as SitesAPI from "./sites/sites.js";
import { Site, SiteCreateParams, SiteDeleteParams, SiteEditParams, SiteGetParams, SiteListParams, SiteLocation, SiteUpdateParams, Sites, SitesSinglePage } from "./sites/sites.js";
export declare class MagicTransit extends APIResource {
    apps: AppsAPI.Apps;
    cfInterconnects: CfInterconnectsAPI.CfInterconnects;
    greTunnels: GRETunnelsAPI.GRETunnels;
    ipsecTunnels: IPSECTunnelsAPI.IPSECTunnels;
    routes: RoutesAPI.Routes;
    sites: SitesAPI.Sites;
    connectors: ConnectorsAPI.Connectors;
    pcaps: PCAPsAPI.PCAPs;
}
...
export declare namespace HealthCheckParam {
    /**
     * The destination address in a request type health check. After the healthcheck is
     * decapsulated at the customer end of the tunnel, the ICMP echo will be forwarded
     * to this address. This field defaults to `customer_gre_endpoint address`. This

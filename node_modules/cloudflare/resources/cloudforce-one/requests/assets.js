...
class Assets extends resource_1.APIResource {
    ...
    create(accountIdentifier, requestIdentifier, body, options) {
        return this._client.post(`/accounts/${accountIdentifier}/cloudforce-one/requests/${requestIdentifier}/asset`, {
            body,
            ...options,
    ...
    get(accountIdentifier, requestIdentifier, assetIdentifer, options) {
        return this._client.get(`/accounts/${accountIdentifier}/cloudforce-one/requests/${requestIdentifier}/asset/${assetIdentifer}`, options)._thenUnwrap((obj) => obj.result);
    }
}

...
export declare class Rules extends APIResource {
     ...
     */
    resetExpiration(ruleId: string, params: RuleResetExpirationParams, options?: Core.RequestOptions): Core.APIPromise<GatewayRule>;
}
export declare class GatewayRulesSinglePage extends SinglePage<GatewayRule> {
}
...
export interface GatewayRule {
     ...
     */
    action?: 'on' | 'off' | 'allow' | 'block' | 'scan' | 'noscan' | 'safesearch' | 'ytrestricted' | 'isolate' | 'noisolate' | 'override' | 'l4_override' | 'egress' | 'resolve' | 'quarantine';
    created_at?: string;
    /**
...
export declare namespace GatewayRule {
    /**
     * The expiration time stamp and default duration of a DNS policy. Takes precedence
     * over the policy's `schedule` configuration, if any.
     *
...
export declare namespace RuleSetting {
    /**
     * Settings for the Audit SSH action.
     */
    interface AuditSSH {
    ...
    interface Quarantine {
         ...
         */
        file_types?: Array<'exe' | 'pdf' | 'doc' | 'docm' | 'docx' | 'rtf' | 'ppt' | 'pptx' | 'xls' | 'xlsm' | 'xlsx' | 'zip' | 'rar'>;
    }
    /**
     * Configure to forward the query to the internal DNS service, passing the
     * specified 'view_id' as input. Cannot be set when 'dns_resolvers' are specified
     ...
     * set to 'resolve'.
     */
    interface ResolveDNSInternally {
        /**
...
export declare namespace RuleSettingParam {
    /**
     * Settings for the Audit SSH action.
     */
    interface AuditSSH {

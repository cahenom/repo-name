...
export declare class Targets extends APIResource {
    /**
     * Create new target
     */
     ...
     * Update target
     */
    update(targetId: string, params: TargetUpdateParams, options?: Core.RequestOptions): Core.APIPromise<TargetUpdateResponse>;
    /**
     ...
     */
    list(params: TargetListParams, options?: Core.RequestOptions): Core.PagePromise<TargetListResponsesV4PagePaginationArray, TargetListResponse>;
    /**
     * Delete target
     */
     ...
     */
    bulkUpdate(params: TargetBulkUpdateParams, options?: Core.RequestOptions): Core.APIPromise<TargetBulkUpdateResponse>;
    /**
     * Get target
     */
    get(targetId: string, params: TargetGetParams, options?: Core.RequestOptions): Core.APIPromise<TargetGetResponse>;
}
export declare class TargetListResponsesV4PagePaginationArray extends V4PagePaginationArray<TargetListResponse> {
}
...
export declare namespace TargetCreateResponse {
    /**
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    interface IP {
...
export declare namespace TargetUpdateResponse {
    /**
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    interface IP {
...
export declare namespace TargetListResponse {
    /**
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    interface IP {
...
export declare namespace TargetBulkUpdateResponse {
    interface TargetBulkUpdateResponseItem {
        /**
         * Target identifier
         */
        id: string;
    ...
    namespace TargetBulkUpdateResponseItem {
        /**
         * The IPv4/IPv6 address that identifies where to reach a target
         */
        interface IP {
...
export declare namespace TargetGetResponse {
    /**
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    interface IP {
...
export declare namespace TargetCreateParams {
    /**
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    interface IP {
...
export declare namespace TargetUpdateParams {
    /**
     * The IPv4/IPv6 address that identifies where to reach a target
     */
    interface IP {
...
export declare namespace TargetBulkUpdateParams {
    interface Body {
        /**
...
export declare namespace Targets {
    export { type TargetCreateResponse as TargetCreateResponse, type TargetUpdateResponse as TargetUpdateResponse, type TargetListResponse as TargetListResponse, type TargetBulkUpdateResponse as TargetBulkUpdateResponse, type TargetGetResponse as TargetGetResponse, TargetListResponsesV4PagePaginationArray as TargetListResponsesV4PagePaginationArray, type TargetCreateParams as TargetCreateParams, type TargetUpdateParams as TargetUpdateParams, type TargetListParams as TargetListParams, type TargetDeleteParams as TargetDeleteParams, type TargetBulkDeleteParams as TargetBulkDeleteParams, type TargetBulkUpdateParams as TargetBulkUpdateParams, type TargetGetParams as TargetGetParams, };
}

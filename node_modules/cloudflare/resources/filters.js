...
exports.FirewallFiltersV4PagePaginationArray = exports.Filters = void 0;
...
class Filters extends resource_1.APIResource {
    ...
    create(params, options) {
        ...
        return this._client.post(`/zones/${zone_id}/filters`, { body, ...options })._thenUnwrap((obj) => obj.result);
    }
    /**
    ...
    bulkDelete(params, options) {
        const { zone_id } = params;
        return this._client.delete(`/zones/${zone_id}/filters`, options)._thenUnwrap((obj) => obj.result);
    }
    /**
    ...
    bulkUpdate(params, options) {
        const { zone_id, ...body } = params;
        return this._client.put(`/zones/${zone_id}/filters`, { body, ...options })._thenUnwrap((obj) => obj.result);
    }
    /**

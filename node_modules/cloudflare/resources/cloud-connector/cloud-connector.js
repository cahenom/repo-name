...
class CloudConnector extends resource_1.APIResource {
    constructor() {
        super(...arguments);
...
CloudConnector.Rules = rules_1.Rules;
CloudConnector.RuleListResponsesSinglePage = rules_1.RuleListResponsesSinglePage;

...
exports.TagListResponsesSinglePage = exports.Tags = void 0;
...
class Tags extends resource_1.APIResource {
    ...
    update(dispatchNamespace, scriptName, params, options) {
        ...
        return this._client.put(`/accounts/${account_id}/workers/dispatch/namespaces/${dispatchNamespace}/scripts/${scriptName}/tags`, { body: body, ...options })._thenUnwrap((obj) => obj.result);
    }
    /**

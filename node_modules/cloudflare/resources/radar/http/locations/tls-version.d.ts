...
export declare class TLSVersion extends APIResource {
    /**
...
export declare namespace TLSVersionGetResponse {
    interface Meta {
...
export declare namespace TLSVersion {
    export { type TLSVersionGetResponse as TLSVersionGetResponse, type TLSVersionGetParams as TLSVersionGetParams, };
}
//# sourceMappingURL=tls-version.d.ts.map
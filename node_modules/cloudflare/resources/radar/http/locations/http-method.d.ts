...
export declare class HTTPMethod extends APIResource {
    /**
...
export declare namespace HTTPMethodGetResponse {
    interface Meta {
...
export declare namespace HTTPMethod {
    export { type HTTPMethodGetResponse as HTTPMethodGetResponse, type HTTPMethodGetParams as HTTPMethodGetParams, };
}

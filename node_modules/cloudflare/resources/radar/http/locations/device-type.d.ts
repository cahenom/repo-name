...
export declare class DeviceType extends APIResource {
    /**
...
export declare namespace DeviceTypeGetResponse {
    interface Meta {
...
export declare namespace DeviceType {
    export { type DeviceTypeGetResponse as DeviceTypeGetResponse, type DeviceTypeGetParams as DeviceTypeGetParams, };
}

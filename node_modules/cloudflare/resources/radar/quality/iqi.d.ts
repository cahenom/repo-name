...
export declare class IQI extends APIResource {
    /**
...
export declare namespace IQISummaryResponse {
    interface Meta {
...
export declare namespace IQITimeseriesGroupsResponse {
    interface Serie0 {
        p25: Array<string>;
        p50: Array<string>;
        p75: Array<string>;
...
export declare namespace IQI {
    export { type IQISummaryResponse as IQISummaryResponse, type IQITimeseriesGroupsResponse as IQITimeseriesGroupsResponse, type IQISummaryParams as IQISummaryParams, type IQITimeseriesGroupsParams as IQITimeseriesGroupsParams, };
}
//# sourceMappingURL=iqi.d.ts.map
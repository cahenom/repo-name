...
export declare class Messages extends APIResource {
     ...
     */
    pull(queueId: string, params: MessagePullParams, options?: Core.RequestOptions): Core.APIPromise<MessagePullResponse>;
}
...
export declare namespace Messages {
    export { type MessageAckResponse as MessageAckResponse, type MessagePullResponse as MessagePullResponse, type MessageAckParams as MessageAckParams, type MessagePullParams as MessagePullParams, };
}
